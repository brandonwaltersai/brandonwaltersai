...
![SecurityX](https://img.shields.io/badge/CompTIA-SecurityX-3E6B8A)
...
|---|---|
| [rag-capstone-qa](https://github.com/brandonwaltersai/rag-capstone-qa) | Retrieval-grounded QA with hybrid retrieval, hard citation validation, pre-generation safety escalation, structured human handoff, and reproducible evaluation — 100% grounded-answer rate, 98.3% retrieval coverage, 89.2% escalation appropriateness, 2.00s mean / 3.01s p95 latency |
