...
| [deep-learning-computer-vision](https://github.com/brandonwaltersai/deep-learning-computer-vision) | CNN architecture search on Fashion-MNIST (5 variants, real trained results) paired with a DCGAN trained from scratch for 40 epochs — real generated samples and loss curves, not unexecuted template code |
